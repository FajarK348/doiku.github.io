...
const questions = [
    {
        question: "毎年6月の中旬から7月の中旬に____雨がちの天気が続く季節がある。",
        options: ["たいして", "かけて", "して", "つけて"],
        answer: "かけて"
    },
    {
        question: "沖縄は最も早く梅雨に入り、そして早く梅雨が____。",
        options: ["異なる", "明ける", "感じる", "比べる"],
        answer: "明ける"
    },
    {
        question: "雨は大切な水資源なので、雨があまり降らないと____の水不足が心配になる。",
        options: ["春の間", "秋の間", "冬の間", "夏の間"],
        answer: "夏の間"
    },
    {
        question: "冷蔵庫に入れたものは____だが、悪くならないうちにできるだけ早く食べてしまうことだ。",
        options: ["忘れがち", "飲みがち", "食べがち", "置きがち"],
        answer: "忘れがち"
    },
    {
        question: "やはり____日よりもからっと晴れた日のほうがいいものだ。",
        options: ["天気がいい", "じめじめした", "曇りの", "快晴日"],
        answer: "じめじめした"
    },
];
