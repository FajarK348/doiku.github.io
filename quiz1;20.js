...
const questions = [
    {
        question: "____同士のコミュニケーションもその一つである。",
        options: ["運転士", "運転者", "運転手", "運転席"],
        answer: "運転手"
    },
    {
        question: "コミュニケーションといっても、____運転手が窓を開けて大きな声で言葉を交わすわけではない。",
        options: ["わざと", "わざわざ", "せっかく", "あえて"],
        answer: "わざわざ" 
    },
    {
        question: "無理に隣の____に割り込んだ時には後ろの車に対してハザードランプを数回点滅させる。",
        options: ["車線", "斜線", "社線", "対向車"],
        answer: "車線"
    },
    {
        question: "どんな____がどんな意味になるかお互いに共通した理解がなければならない。",
        options: ["目印", "合図", "跡", "信号"],
        answer: "合図"
    },
    {
        question: "さらに面白いことには、この合図にも『____』があるという。",
        options: ["言葉", "俚言", "方言", "訛言"],
        answer: "方言"
    },
];
