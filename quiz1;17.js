...
const questions = [
    {
        question: "ある____ものが見えたり、あるはずのものが見えなかったりすることがある。",
        options: ["がない", "はず", "はずがない", "の"],
        answer: "はずがない"
    },
    {
        question: "決して目がおかしくなったの____。",
        options: ["です", "ものだ", "べきだ", "ではない"],
        answer: "ではない"
    },
    {
        question: "動物たちは絵の中から今にも飛び出してきそうに見えるし、子供は絵から落ち____いる。",
        options: ["して", "なって", "そうにして", "そうになって"],
        answer: "そうになって"
    },
    {
        question: "反対に婦人が見えているときには老婆は____。 実に不思議なものである。",
        options: ["見えない", "見える", "合わない", "動かない"],
        answer: "見えない"
    },
    {
        question: "あなたもここに来ればそれを実感する____。",
        options: ["はずだ", "べきだ", "になった", "にちがいない"],
        answer: "にちがいない"
    },
];
