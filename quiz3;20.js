const questions = [
    { question: "それですべての学習が終わるわけです。", answer: false },
    { question: "実際に田舎に出て走りながら身につける技術というものもある。", answer: false },
    { question: "わざわざ運転者が窓を開けて大きな声で言葉を交わすわけではない。", answer: false },
    { question: "音と光の合図で会話するのである。", answer: true },
    { question: "さらに面白いことには、この合図にも『方言』があるという。", answer: true },
];
