...
const paragraphContent = "もしにおいを説明するのに、「いい香り」と「臭い」しか言葉がなかったら寂しい。そのにおいを相手に伝えたいと思えば、それと似ている香りを探して、「バラの花のような香りがする」とか「卵が腐ったみたいなにおいがする」と表現することができる。つまり、何かほかのものにたとえることによって、相手はそれがどんなものかイメージすることができるのだ。そのおかげで私たちの表現は一層豊かになる。";
