const questions = [
    { question: "幼稚園のころは適当にうまく話して納得させていた。", answer: true },
    { question: "小学2年生の質問は「あさってはどこにあるのですか」だった。", answer: false },
    { question: "ゲストの人がどう答えるのかと思っていたら、案の定、困っているようだった。", answer: true },
    { question: "次にもう一人のゲストは、逆に中学生に「どうしてそれが知りたいのかな」と質問をした。", answer: false },
    { question: "答えるからにはこちらも考えることが不要だ。", answer: false },
];
