const questions = [
    { question: "線がないのに、白い三角形があるように見える。", answer: true },
    { question: "下の絵は婦人が斜め後ろを向いている絵であることはわかるが、実は見方を変えると老婆が現れる。", answer: true },
    { question: "首飾りの部分が唇だと意識すれば現れるはずだ。", answer: false },
    { question: "絵の額縁も含めてすべて壁に直接特殊なインクを塗ってかかれている。", answer: false },
    { question: "室内を薄暗くして、光を当てることによって、立体的に見えるのである。", answer: true },
];
