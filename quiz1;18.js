...
const questions = [
    {
        question: "おもしろいことを言うものだと思ったが、____一緒に食べに行くことにした。",
        options: ["たしかに", "まさに", "とにかく", "とりあえず"],
        answer: "とにかく"
    },
    {
        question: "予想どおり、私たちが着いた時には、もう____30人ほど店の前に並んでいた。",
        options: ["すぐに", "すでに", "まさに", "とにかく"],
        answer: "すでに" 
    },
    {
        question: "でも時計を見たら、40分近く並んでいた。____、注文したラーメンが目の前に運ばれて来た。",
        options: ["そして", "しばらくして", "そうにして", "すでにすでに"],
        answer: "しばらくして"
    },
    {
        question: "____期待どおりのラーメンを味わって私たちは店を出た。",
        options: ["すぐに", "すでに", "まさに", "とにかく"],
        answer: "まさに"
    },
    {
        question: "____行列ができるくらいだからまずいはずがない。。",
        options: ["確かに", "すでに", "まさに", "とにかく"],
        answer: "確かに"
    },
];
